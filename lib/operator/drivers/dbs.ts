...
const TRANSACTION_CODES: Record<string, string> = {
  ...
  "FDP": "Fixed Deposit Principal Amount",
  "FDW": "Fixed Deposit Principal Amount",
  ...
  "HSL": "Bill Payment to HSBC LIFE (SINGAPORE) PTE LTD for Policy Premium",
  "HSLI": "Bill Payment to HSBC LIFE (SINGAPORE) PTE LTD for Policy Premium",
  ...
  "SPH": "Bill Payment to SPH Media Limited - Advertisement/Subscription",
  "SPHM": "Bill Payment to SPH Media Limited - Advertisement/Subscription",
